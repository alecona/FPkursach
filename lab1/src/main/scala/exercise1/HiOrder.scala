...
/**
  ...
  println("testNTimes(plus, 2, 3, 4):\t" + testNTimes(plus, 2, 3, 4))
  println("testAnonymousNTimes(2, 3, 4):\t" + testAnonymousNTimes(2, 3, 4))
  println("testAnonymousNTimes(4, 1, 4):\t" + testAnonymousNTimes(4, 1, 4))
 **/
}