...
object Adts extends App{
  ...
  def safeDivide(a: Int, b: Int): Either[String, Int] =
    if (b != 0) Right(a / b) else Left("Вы не можете делить на ноль.")
...
/**
  ...
  println("testGetNth(List(2, 4, 6, 8, 10), 4):  " + testGetNth(List(2, 4, 6, 8, 10), 4))
  println("testDouble(Some(2)):  " + testDouble(Some(2)))
  println("testIsEven(1):  " + testIsEven(1))
  ...
  println("testGoodOldJava((i:String) => i.toInt,\"5\"):  " +
    testGoodOldJava((i:String) => i.toInt,"5"))
  println("testGoodOldJava((i:String) => i.toInt,\"a\"):  " +
    testGoodOldJava((i:String) => i.toInt,"a"))
**/
}